-- This migration is intentionally NOT included in db/bootstrap.ts.
-- It is installed transactionally only by the explicitly confirmed one-time
-- administrator operation, never during build, deploy, preview, or app startup.
