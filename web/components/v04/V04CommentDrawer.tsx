...
export default function V04CommentDrawer({ videoId, open, onClose, onLocate, readOnly = false, draft }: { videoId: string; open: boolean; onClose: () => void; onLocate?: (id: string) => void; readOnly?: boolean; draft?: V04UiDraft }) {
